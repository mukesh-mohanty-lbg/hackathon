...
import { ChevronRight, TrendingUp, Calendar, CheckCircle2, Clock, Search, PlusCircle, Info } from 'lucide-react'
...
export function EventsList({ onNavigate }: EventsListProps) {
  const { events, currentUser, bookSessionsForCurrentUser } = useApp()
